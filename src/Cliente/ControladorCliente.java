...
/**
 * Clase controlador del cliente (MVC), el cual recibirá todos los datos del servidor
 * y se los pasará a las vistas.
 * 
...
public class ControladorCliente extends Observable {
    ...
    /**
     * Conecta al Cliente y al Servidor y inicia un hilo que escucha 
    ...
    public void establecerConexion(){
        ...
        while (reintentar) { //Se intenta conectar hasta que lo consigue.
            try {
                String[] datos = PeticionIPPuerto.pedirIPPuerto(); //Recoge los datos necesarios para establecer la conexión.
                ...
                //Si surge algun problema lanza excepción y pregunta si se quiere intentar otra vez.
    ...
    /**
     * Envia al servidor un Fin, seguidamente cierra conexión.
     */
    ...
    /**
     * Determina qué hacer con cada mensaje recibido por el hilo de escucha.
     * 
    ...
    public void selectorMensaje(String msg) {
        if (msg != null) {
            ...
            switch (parseado[0]) {
                ...
                case "COI": {
                    //Envía a la vista el mismo mensaje recibido.
                    notifyObservers(msg);
                    break;
                }
                case "MOV": {
                ...
                case "ERR": {
                    //Muestra el mensaje de error recibido y termina la conexión.
                    notifyObservers(msg);
                    this.listener.cerrarConexion();
                    System.exit(0);
                    break;
